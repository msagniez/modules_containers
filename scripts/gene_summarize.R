...
if (length(args) < 2) {
  ...
  cat("  --ignore-tx-version  Strip version suffixes from transcript IDs (e.g. ENST00000516118.1 -> ENST00000516118)\n")
  cat("                       Use this when input transcript IDs have versions but the reference does not, or vice versa\n")
